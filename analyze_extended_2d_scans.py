...
# local imports
try:
    from modules.analysis_tools_2d_scans import transform_between_sensor_stage_coordinates
except ModuleNotFoundError:
    import sys
    sys.path.insert(1, os.path.join(sys.path[0], '..'))
finally:
    from modules.analysis_tools_2d_scans import transform_between_sensor_stage_coordinates, get_relative_inplane_angles, get_direction_vector
    from modules.data_management import extract_raw_data_from_2d_scan
    from modules.plotting_tools import plot_2d_scan


#%%
# retrieve data from previous scans
directory = './test_data/2d_scans_different_fields/set7'
# directory = r'data_sets\2d_scans_different_fields\set3'

filenames = ['21_01_19_18-02-59_2d_scan_(1_0_0).csv',   # (100)   
            '21_01_19_18-20-01_2d_scan_(0_1_0).csv',    # (010) 
            '21_01_19_19-01-04_2d_scan_(0_0_1).csv',    # (001)   
            '21_01_19_16-53-58_2d_scan_(1_1_1).csv']    # (111)  
